  ...
  public: {
    Tables: {
      ...
      match_request_responses: {
        ...
        Relationships: [
          {
            foreignKeyName: "match_request_responses_request_id_fkey"
            columns: ["request_id"]
            isOneToOne: false
      ...
      match_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "match_requests_court_preference_fkey"
            columns: ["court_preference"]
            isOneToOne: false
            referencedRelation: "courts"
            referencedColumns: ["id"]
          },
      ...
      match_statistics: {
        Row: {
          ...
          first_serve_percentage: number | null
          id: string
          match_id: string
          player_id: string
      ...
      user_settings: {
        Row: {
          court_updates: boolean | null
          created_at: string | null
          email_notifications: boolean | null
          id: string
          language: string | null
          match_reminders: boolean | null
          privacy_history_visible: boolean | null
          privacy_profile_visible: boolean | null
          privacy_skill_visible: boolean | null
    ...
    Functions: {
      ...
      skill_level_to_int: {
        Args: {
          s: Database["public"]["Enums"]["skill_level"]
        }
        Returns: number
      }
      spheroid_in: {
    ...
    Enums: {
      ...
      request_status: "open" | "pending" | "confirmed" | "cancelled"
      request_visibility: "public" | "skill_level" | "private"
      skill_level: "1" | "2" | "3" | "4" | "5"
      surface_type: "clay" | "hard" | "grass" | "artificial"
      user_status: "online" | "playing" | "away"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
