...
ALTER TYPE "public"."achievement_tier" OWNER TO "postgres";
...
CREATE TYPE "public"."match_request_response_status" AS ENUM (
    'pending',
    'accepted',
    'rejected'
);
...
ALTER TYPE "public"."match_request_response_status" OWNER TO "postgres";
...
ALTER TYPE "public"."match_response_status" OWNER TO "postgres";
...
CREATE TYPE "public"."request_visibility" AS ENUM (
    'public',
    'skill_level',
    'private'
);
...
ALTER TYPE "public"."request_visibility" OWNER TO "postgres";
...
ALTER TYPE "public"."training_session_status" OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."award_achievement"("p_user_id" "uuid", "p_type" "public"."achievement_type", "p_name" "text", "p_description" "text", "p_tier" "public"."achievement_tier", "p_icon_path" "text", "p_metadata" "jsonb" DEFAULT '{}'::"jsonb") RETURNS "void"
...
ALTER FUNCTION "public"."award_achievement"("p_user_id" "uuid", "p_type" "public"."achievement_type", "p_name" "text", "p_description" "text", "p_tier" "public"."achievement_tier", "p_icon_path" "text", "p_metadata" "jsonb") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."award_achievements_with_notifications"("p_user_id" "uuid", "p_achievements" "jsonb") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  achievement RECORD;
...
ALTER FUNCTION "public"."award_achievements_with_notifications"("p_user_id" "uuid", "p_achievements" "jsonb") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."award_xp"("p_user_id" "uuid", "p_activity_type" "text", "p_description" "text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
...
ALTER FUNCTION "public"."award_xp"("p_user_id" "uuid", "p_activity_type" "text", "p_description" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."calculate_player_level"("xp" integer) RETURNS integer
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."calculate_player_level"("xp" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."calculate_player_stats"("player_uuid" "uuid") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    total_count INTEGER;
...
ALTER FUNCTION "public"."calculate_player_stats"("player_uuid" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."calculate_xp_for_level"("level_number" integer) RETURNS integer
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."calculate_xp_for_level"("level_number" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."check_match_needs_winner_selection"("match_id" "uuid", "user_id" "uuid") RETURNS boolean
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    match_record RECORD;
...
ALTER FUNCTION "public"."check_match_needs_winner_selection"("match_id" "uuid", "user_id" "uuid") OWNER TO "postgres";


CREATE PROCEDURE "public"."create_court_booking"(IN "p_user_id" "uuid", IN "p_court_id" integer, IN "p_start_time" timestamp with time zone, IN "p_end_time" timestamp with time zone, IN "p_players" integer)
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    v_court_name TEXT;
...
ALTER PROCEDURE "public"."create_court_booking"(IN "p_user_id" "uuid", IN "p_court_id" integer, IN "p_start_time" timestamp with time zone, IN "p_end_time" timestamp with time zone, IN "p_players" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_court_booking"("p_user_id" "uuid", "p_court_id" "uuid", "p_start_time" "text", "p_end_time" "text", "p_players" integer) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    v_court_name TEXT;
...
ALTER FUNCTION "public"."create_court_booking"("p_user_id" "uuid", "p_court_id" "uuid", "p_start_time" "text", "p_end_time" "text", "p_players" integer) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."create_notification"("p_user_id" "uuid", "p_type" "public"."notification_type", "p_title" "text", "p_message" "text", "p_data" "jsonb" DEFAULT '{}'::"jsonb") RETURNS "public"."notifications"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
ALTER FUNCTION "public"."create_notification"("p_user_id" "uuid", "p_type" "public"."notification_type", "p_title" "text", "p_message" "text", "p_data" "jsonb") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_test_notifications"("p_user_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."create_test_notifications"("p_user_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_training_session"("p_student_id" "uuid", "p_coach_id" "uuid", "p_start_time" "text", "p_end_time" "text", "p_notes" "text" DEFAULT NULL::"text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    v_coach_name TEXT;
...
ALTER FUNCTION "public"."create_training_session"("p_student_id" "uuid", "p_coach_id" "uuid", "p_start_time" "text", "p_end_time" "text", "p_notes" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_xp_multiplier_details"("activity" "public"."activity_type") RETURNS TABLE("multiplier" double precision, "base_xp" integer, "description" "text")
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    RETURN QUERY SELECT
...
ALTER FUNCTION "public"."get_xp_multiplier_details"("activity" "public"."activity_type") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."handle_match_completion"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."handle_match_completion"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."handle_partner_request_response"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."handle_partner_request_response"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."handle_winner_selection"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  match_record RECORD;
...
ALTER FUNCTION "public"."handle_winner_selection"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."skill_level_to_int"("s" "public"."skill_level") RETURNS integer
...
ALTER FUNCTION "public"."skill_level_to_int"("s" "public"."skill_level") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_daily_streak"("user_id" "uuid") RETURNS TABLE("streak_days" integer, "xp_gained" integer, "streak_broken" boolean)
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    last_date DATE;
...
CREATE OR REPLACE FUNCTION "public"."update_player_level"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    new_level INTEGER;
...
ALTER FUNCTION "public"."update_player_level"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_player_stats_on_match_change"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."update_player_stats_on_match_change"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_player_stats_on_xp_change"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."update_player_stats_on_xp_change"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."validate_match_selection"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."validate_match_selection"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."court_bookings" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "court_bookings_players_check" CHECK ((("players" >= 1) AND ("players" <= 4)))
);
...
CREATE SEQUENCE IF NOT EXISTS "public"."courts_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."match_request_responses" (
    ...
    "status" "public"."match_request_response_status" DEFAULT 'pending'::"public"."match_request_response_status",
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
    "updated_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"())
);


ALTER TABLE "public"."match_request_responses" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."match_requests" (
    ...
    "court_preference" "uuid",
    "visibility" "public"."request_visibility" DEFAULT 'skill_level'::"public"."request_visibility",
    "status" "public"."request_status" DEFAULT 'open'::"public"."request_status",
    "notes" "text",
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
    "updated_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
    CONSTRAINT "valid_skill_levels" CHECK (((("skill_level_min" >= 1) AND ("skill_level_min" <= 5)) AND (("skill_level_max" >= 1) AND ("skill_level_max" <= 5)))),
...
CREATE TABLE IF NOT EXISTS "public"."match_statistics" (
    ...
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
    CONSTRAINT "valid_counts" CHECK ((("aces" >= 0) AND ("double_faults" >= 0) AND ("winners" >= 0) AND ("unforced_errors" >= 0))),
    CONSTRAINT "valid_percentages" CHECK ((("first_serve_percentage" >= 0) AND ("first_serve_percentage" <= 100)))
);


ALTER TABLE "public"."match_statistics" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."match_winner_selections" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "match_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."match_winner_selections" OWNER TO "postgres";
...
ALTER TABLE "public"."player_experience" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."player_skills" (
    ...
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
    "updated_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
    CONSTRAINT "player_skills_level_check" CHECK ((("level" >= 1) AND ("level" <= 5)))
);
...
CREATE TABLE IF NOT EXISTS "public"."player_stats" (
    ...
    "won_matches" integer DEFAULT 0 NOT NULL,
    "win_rate" numeric(5,2) DEFAULT 0 NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"(),
    "total_bookings" integer DEFAULT 0,
    "total_trainings" integer DEFAULT 0,
    "current_streak" integer DEFAULT 0,
    CONSTRAINT "win_rate_range" CHECK ((("win_rate" >= (0)::numeric) AND ("win_rate" <= (100)::numeric)))
);
...
ALTER TABLE "public"."player_xp" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."profiles" (
    ...
    "skill_level" integer,
    "avatar_url" "text",
    "status" "public"."user_status" DEFAULT 'online'::"public"."user_status",
    ...
    CONSTRAINT "profiles_level_check" CHECK ((("level" >= 1) AND ("level" <= 5))),
    CONSTRAINT "profiles_matches_won_check" CHECK (("matches_won" >= 0)),
    CONSTRAINT "profiles_skill_level_check" CHECK ((("skill_level" >= 1) AND ("skill_level" <= 10)))
);
...
ALTER TABLE ONLY "public"."training_sessions" REPLICA IDENTITY FULL;
...
ALTER TABLE ONLY "public"."match_request_responses"
    ADD CONSTRAINT "match_request_responses_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."match_winner_selections"
    ADD CONSTRAINT "match_winner_selections_match_id_selector_id_key" UNIQUE ("match_id", "selector_id");



ALTER TABLE ONLY "public"."match_winner_selections"
    ADD CONSTRAINT "match_winner_selections_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."bookings"
    ADD CONSTRAINT "no_overlapping_bookings" EXCLUDE USING "gist" ("court_id" WITH =, "tstzrange"("start_time", "end_time", '[)'::"text") WITH &&);



ALTER TABLE ONLY "public"."training_sessions"
    ADD CONSTRAINT "no_overlapping_sessions" EXCLUDE USING "gist" ("coach_id" WITH =, "tstzrange"("start_time", "end_time") WITH &&);
...
ALTER TABLE ONLY "public"."notifications"
    ADD CONSTRAINT "notifications_user_id_type_key" UNIQUE ("user_id", "id");



ALTER TABLE ONLY "public"."player_experience"
    ADD CONSTRAINT "player_experience_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."player_skills"
    ADD CONSTRAINT "player_skills_user_id_skill_type_key" UNIQUE ("user_id", "skill_type");
...
ALTER TABLE ONLY "public"."player_xp"
    ADD CONSTRAINT "player_xp_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."player_xp"
    ADD CONSTRAINT "player_xp_user_id_key" UNIQUE ("user_id");
...
ALTER TABLE ONLY "public"."match_request_responses"
    ADD CONSTRAINT "unique_response" UNIQUE ("request_id", "responder_id");
...
ALTER TABLE ONLY "public"."xp_multipliers"
    ADD CONSTRAINT "xp_multipliers_activity_type_key" UNIQUE ("activity_type");
...
CREATE OR REPLACE TRIGGER "handle_match_completion_trigger" BEFORE UPDATE OF "winner_id" ON "public"."matches" FOR EACH ROW EXECUTE FUNCTION "public"."handle_match_completion"();



CREATE OR REPLACE TRIGGER "handle_partner_request_response_trigger" BEFORE UPDATE OF "status" ON "public"."match_request_responses" FOR EACH ROW EXECUTE FUNCTION "public"."handle_partner_request_response"();



CREATE OR REPLACE TRIGGER "match_stats_update" AFTER INSERT OR UPDATE OF "winner_id" ON "public"."matches" FOR EACH ROW EXECUTE FUNCTION "public"."update_player_stats_on_match_change"();



CREATE OR REPLACE TRIGGER "player_xp_stats_update" AFTER INSERT OR UPDATE OF "current_level" ON "public"."player_xp" FOR EACH ROW EXECUTE FUNCTION "public"."update_player_stats_on_xp_change"();



CREATE OR REPLACE TRIGGER "set_training_sessions_updated_at" BEFORE UPDATE ON "public"."training_sessions" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
CREATE OR REPLACE TRIGGER "update_court_bookings_updated_at" BEFORE UPDATE ON "public"."court_bookings" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();



CREATE OR REPLACE TRIGGER "update_courts_updated_at" BEFORE UPDATE ON "public"."courts" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();



CREATE OR REPLACE TRIGGER "update_login_streaks_updated_at" BEFORE UPDATE ON "public"."login_streaks" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at"();



CREATE OR REPLACE TRIGGER "update_match_request_responses_updated_at" BEFORE UPDATE ON "public"."match_request_responses" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at"();



CREATE OR REPLACE TRIGGER "update_match_requests_updated_at" BEFORE UPDATE ON "public"."match_requests" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at"();



CREATE OR REPLACE TRIGGER "update_match_winner_selections_updated_at" BEFORE UPDATE ON "public"."match_winner_selections" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
CREATE OR REPLACE TRIGGER "update_player_experience_updated_at" BEFORE UPDATE ON "public"."player_experience" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at"();



CREATE OR REPLACE TRIGGER "update_player_level_trigger" BEFORE UPDATE OF "current_xp" ON "public"."player_xp" FOR EACH ROW EXECUTE FUNCTION "public"."update_player_level"();



CREATE OR REPLACE TRIGGER "update_player_skills_updated_at" BEFORE UPDATE ON "public"."player_skills" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();



CREATE OR REPLACE TRIGGER "update_player_xp_updated_at" BEFORE UPDATE ON "public"."player_xp" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
CREATE OR REPLACE TRIGGER "update_xp_multipliers_updated_at" BEFORE UPDATE ON "public"."xp_multipliers" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();



CREATE OR REPLACE TRIGGER "validate_match_selection_trigger" BEFORE INSERT OR UPDATE ON "public"."match_winner_selections" FOR EACH ROW EXECUTE FUNCTION "public"."validate_match_selection"();



ALTER TABLE ONLY "public"."achievements"
    ADD CONSTRAINT "achievements_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");
...
ALTER TABLE ONLY "public"."coaches"
    ADD CONSTRAINT "coaches_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");
...
ALTER TABLE ONLY "public"."court_bookings"
    ADD CONSTRAINT "court_bookings_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."login_streaks"
    ADD CONSTRAINT "login_streaks_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."match_request_responses"
    ADD CONSTRAINT "match_request_responses_request_id_fkey" FOREIGN KEY ("request_id") REFERENCES "public"."match_requests"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."match_request_responses"
    ADD CONSTRAINT "match_request_responses_responder_id_fkey" FOREIGN KEY ("responder_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."match_requests"
    ADD CONSTRAINT "match_requests_court_preference_fkey" FOREIGN KEY ("court_preference") REFERENCES "public"."courts"("id");



ALTER TABLE ONLY "public"."match_requests"
    ADD CONSTRAINT "match_requests_creator_id_fkey" FOREIGN KEY ("creator_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."match_statistics"
    ADD CONSTRAINT "match_statistics_match_id_fkey" FOREIGN KEY ("match_id") REFERENCES "public"."matches"("id");



ALTER TABLE ONLY "public"."match_statistics"
    ADD CONSTRAINT "match_statistics_player_id_fkey" FOREIGN KEY ("player_id") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."match_winner_selections"
    ADD CONSTRAINT "match_winner_selections_match_id_fkey" FOREIGN KEY ("match_id") REFERENCES "public"."matches"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."match_winner_selections"
    ADD CONSTRAINT "match_winner_selections_selected_winner_id_fkey" FOREIGN KEY ("selected_winner_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."match_winner_selections"
    ADD CONSTRAINT "match_winner_selections_selector_id_fkey" FOREIGN KEY ("selector_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."matches"
    ADD CONSTRAINT "matches_booking_id_fkey" FOREIGN KEY ("booking_id") REFERENCES "public"."bookings"("id");
...
ALTER TABLE ONLY "public"."matches"
    ADD CONSTRAINT "matches_request_id_fkey" FOREIGN KEY ("request_id") REFERENCES "public"."match_requests"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."player_experience"
    ADD CONSTRAINT "player_experience_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."player_skills"
    ADD CONSTRAINT "player_skills_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."player_stats"
    ADD CONSTRAINT "player_stats_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."player_xp"
    ADD CONSTRAINT "player_xp_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."training_sessions"
    ADD CONSTRAINT "training_sessions_coach_id_fkey" FOREIGN KEY ("coach_id") REFERENCES "public"."coaches"("id");



ALTER TABLE ONLY "public"."training_sessions"
    ADD CONSTRAINT "training_sessions_student_id_fkey" FOREIGN KEY ("student_id") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."training_sessions"
    ADD CONSTRAINT "training_sessions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");
...
CREATE POLICY "Allow system functions to update player stats" ON "public"."player_stats" USING (true) WITH CHECK (true);



CREATE POLICY "Allow users to read all player stats" ON "public"."player_stats" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Anyone can view coach profiles" ON "public"."profiles" FOR SELECT USING (("is_coach" = true));



CREATE POLICY "Authenticated users can delete their own coach records" ON "public"."coaches" FOR DELETE TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "id"));



CREATE POLICY "Authenticated users can insert new coaches" ON "public"."coaches" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "Authenticated users can update their own coach records" ON "public"."coaches" FOR UPDATE TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "id")) WITH CHECK (true);
...
CREATE POLICY "Coaches can update own profile" ON "public"."profiles" FOR UPDATE USING ((("auth"."uid"() = "id") AND ("is_coach" = true))) WITH CHECK ((("auth"."uid"() = "id") AND ("is_coach" = true)));
...
CREATE POLICY "Players can insert their own selections" ON "public"."match_winner_selections" FOR INSERT TO "authenticated" WITH CHECK ((("auth"."uid"() = "selector_id") AND (EXISTS ( SELECT 1
   FROM "public"."matches" "m"
  WHERE (("m"."id" = "match_winner_selections"."match_id") AND (("auth"."uid"() = "m"."player1_id") OR ("auth"."uid"() = "m"."player2_id")) AND ("m"."winner_id" IS NULL))))));



CREATE POLICY "Players can manage their own selections" ON "public"."match_winner_selections" TO "authenticated" USING ((("auth"."uid"() = "selector_id") AND (EXISTS ( SELECT 1
   FROM "public"."matches" "m"
  WHERE (("m"."id" = "match_winner_selections"."match_id") AND (("auth"."uid"() = "m"."player1_id") OR ("auth"."uid"() = "m"."player2_id")) AND ("m"."winner_id" IS NULL)))))) WITH CHECK ((("auth"."uid"() = "selector_id") AND (EXISTS ( SELECT 1
   FROM "public"."matches" "m"
  WHERE (("m"."id" = "match_winner_selections"."match_id") AND (("auth"."uid"() = "m"."player1_id") OR ("auth"."uid"() = "m"."player2_id")) AND ("m"."winner_id" IS NULL))))));



CREATE POLICY "Players can view selections for their matches" ON "public"."match_winner_selections" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."matches" "m"
  WHERE (("m"."id" = "match_winner_selections"."match_id") AND (("auth"."uid"() = "m"."player1_id") OR ("auth"."uid"() = "m"."player2_id"))))));



CREATE POLICY "Players can view their matches" ON "public"."matches" FOR SELECT TO "authenticated" USING ((("auth"."uid"() = "player1_id") OR ("auth"."uid"() = "player2_id")));



CREATE POLICY "Players can view their notifications" ON "public"."notifications" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Service role can manage XP history" ON "public"."xp_history" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "System can update experience" ON "public"."player_experience" FOR UPDATE USING (("auth"."uid"() = "user_id"));



CREATE POLICY "System can update matches" ON "public"."matches" FOR UPDATE USING (true) WITH CHECK (true);
...
CREATE POLICY "Users can create match requests" ON "public"."match_requests" FOR INSERT WITH CHECK (("creator_id" = "auth"."uid"()));



CREATE POLICY "Users can create matches from accepted requests" ON "public"."matches" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM ("public"."match_request_responses" "mrr"
     JOIN "public"."match_requests" "mr" ON (("mr"."id" = "mrr"."request_id")))
  WHERE (("mr"."id" = "mrr"."request_id") AND ("mrr"."status" = 'accepted'::"public"."match_request_response_status") AND ((("auth"."uid"() = "mr"."creator_id") AND ("matches"."player1_id" = "mr"."creator_id") AND ("matches"."player2_id" = "mrr"."responder_id")) OR (("auth"."uid"() = "mr"."creator_id") AND ("matches"."player2_id" = "mr"."creator_id") AND ("matches"."player1_id" = "mrr"."responder_id")))))));



CREATE POLICY "Users can create new training sessions" ON "public"."training_sessions" FOR INSERT TO "authenticated" WITH CHECK (("user_id" = "auth"."uid"()));
...
CREATE POLICY "Users can create responses" ON "public"."match_request_responses" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "responder_id"));



CREATE POLICY "Users can create their own bookings" ON "public"."court_bookings" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can create their own requests" ON "public"."match_requests" FOR INSERT WITH CHECK (("creator_id" = "auth"."uid"()));



CREATE POLICY "Users can create winner selections for their matches" ON "public"."match_winner_selections" FOR INSERT WITH CHECK ((("selector_id" = "auth"."uid"()) AND ("match_id" IN ( SELECT "matches"."id"
   FROM "public"."matches"
  WHERE ((("matches"."player1_id" = "auth"."uid"()) OR ("matches"."player2_id" = "auth"."uid"())) AND ("matches"."status" = 'completed'::"public"."match_status") AND ("matches"."winner_id" IS NULL))))));
...
CREATE POLICY "Users can delete their own requests" ON "public"."match_requests" FOR DELETE USING (("creator_id" = "auth"."uid"()));



CREATE POLICY "Users can delete their own training sessions" ON "public"."training_sessions" FOR DELETE TO "authenticated" USING (("user_id" = "auth"."uid"()));
...
CREATE POLICY "Users can insert own skills" ON "public"."player_skills" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can update own skills" ON "public"."player_skills" FOR UPDATE USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can update their own XP" ON "public"."player_xp" FOR UPDATE USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can update their own bookings" ON "public"."court_bookings" FOR UPDATE USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can update their own matches" ON "public"."matches" FOR UPDATE TO "authenticated" USING ((("auth"."uid"() = "player1_id") OR ("auth"."uid"() = "player2_id")));
...
CREATE POLICY "Users can update their own requests" ON "public"."match_requests" FOR UPDATE USING (("creator_id" = "auth"."uid"())) WITH CHECK (("creator_id" = "auth"."uid"()));



CREATE POLICY "Users can update their own responses" ON "public"."match_request_responses" FOR UPDATE TO "authenticated" USING ((("auth"."uid"() = "responder_id") OR ("auth"."uid"() IN ( SELECT "match_requests"."creator_id"
   FROM "public"."match_requests"
  WHERE ("match_requests"."id" = "match_request_responses"."request_id")))));



CREATE POLICY "Users can update their own training sessions" ON "public"."training_sessions" FOR UPDATE TO "authenticated" USING (("user_id" = "auth"."uid"())) WITH CHECK (("user_id" = "auth"."uid"()));



CREATE POLICY "Users can view XP multipliers" ON "public"."xp_multipliers" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Users can view all match requests" ON "public"."match_requests" FOR SELECT USING (true);
...
CREATE POLICY "Users can view own skills" ON "public"."player_skills" FOR SELECT USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can view responses for their requests" ON "public"."match_request_responses" FOR SELECT TO "authenticated" USING (("auth"."uid"() IN ( SELECT "match_requests"."creator_id"
   FROM "public"."match_requests"
  WHERE ("match_requests"."id" = "match_request_responses"."request_id"))));



CREATE POLICY "Users can view responses to their requests" ON "public"."match_request_responses" FOR SELECT USING ((("auth"."uid"() IN ( SELECT "match_requests"."creator_id"
   FROM "public"."match_requests"
  WHERE ("match_requests"."id" = "match_request_responses"."request_id"))) OR ("responder_id" = "auth"."uid"())));



CREATE POLICY "Users can view their match statistics" ON "public"."match_statistics" FOR SELECT USING ((("auth"."uid"() = "player_id") OR ("auth"."uid"() IN ( SELECT "m"."player1_id"
   FROM "public"."matches" "m"
...
CREATE POLICY "Users can view their matches" ON "public"."matches" FOR SELECT USING ((("auth"."uid"() = "player1_id") OR ("auth"."uid"() = "player2_id")));



CREATE POLICY "Users can view their own XP" ON "public"."player_xp" FOR SELECT USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can view their own XP history" ON "public"."xp_history" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can view their own bookings" ON "public"."court_bookings" FOR SELECT USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can view their own experience" ON "public"."player_experience" FOR SELECT USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can view their own matches" ON "public"."matches" FOR SELECT TO "authenticated" USING ((("auth"."uid"() = "player1_id") OR ("auth"."uid"() = "player2_id")));
...
CREATE POLICY "Users can view their own responses" ON "public"."match_request_responses" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "responder_id"));



CREATE POLICY "Users can view their own training sessions" ON "public"."training_sessions" FOR SELECT TO "authenticated" USING (("user_id" = "auth"."uid"()));



CREATE POLICY "Users can view winner selections for their matches" ON "public"."match_winner_selections" FOR SELECT USING (("match_id" IN ( SELECT "matches"."id"
   FROM "public"."matches"
  WHERE (("matches"."player1_id" = "auth"."uid"()) OR ("matches"."player2_id" = "auth"."uid"())))));
...
ALTER TABLE "public"."match_winner_selections" ENABLE ROW LEVEL SECURITY;
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."match_winner_selections";
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."training_sessions";
...
GRANT ALL ON FUNCTION "public"."award_achievement"("p_user_id" "uuid", "p_type" "public"."achievement_type", "p_name" "text", "p_description" "text", "p_tier" "public"."achievement_tier", "p_icon_path" "text", "p_metadata" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."award_achievement"("p_user_id" "uuid", "p_type" "public"."achievement_type", "p_name" "text", "p_description" "text", "p_tier" "public"."achievement_tier", "p_icon_path" "text", "p_metadata" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."award_achievement"("p_user_id" "uuid", "p_type" "public"."achievement_type", "p_name" "text", "p_description" "text", "p_tier" "public"."achievement_tier", "p_icon_path" "text", "p_metadata" "jsonb") TO "service_role";



GRANT ALL ON FUNCTION "public"."award_achievements_with_notifications"("p_user_id" "uuid", "p_achievements" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."award_achievements_with_notifications"("p_user_id" "uuid", "p_achievements" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."award_achievements_with_notifications"("p_user_id" "uuid", "p_achievements" "jsonb") TO "service_role";



GRANT ALL ON FUNCTION "public"."award_xp"("p_user_id" "uuid", "p_activity_type" "text", "p_description" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."award_xp"("p_user_id" "uuid", "p_activity_type" "text", "p_description" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."award_xp"("p_user_id" "uuid", "p_activity_type" "text", "p_description" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."calculate_player_level"("xp" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."calculate_player_level"("xp" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."calculate_player_level"("xp" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."calculate_player_stats"("player_uuid" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."calculate_player_stats"("player_uuid" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."calculate_player_stats"("player_uuid" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."calculate_xp_for_level"("level_number" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."calculate_xp_for_level"("level_number" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."calculate_xp_for_level"("level_number" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."check_match_needs_winner_selection"("match_id" "uuid", "user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."check_match_needs_winner_selection"("match_id" "uuid", "user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."check_match_needs_winner_selection"("match_id" "uuid", "user_id" "uuid") TO "service_role";
...
GRANT ALL ON PROCEDURE "public"."create_court_booking"(IN "p_user_id" "uuid", IN "p_court_id" integer, IN "p_start_time" timestamp with time zone, IN "p_end_time" timestamp with time zone, IN "p_players" integer) TO "anon";
GRANT ALL ON PROCEDURE "public"."create_court_booking"(IN "p_user_id" "uuid", IN "p_court_id" integer, IN "p_start_time" timestamp with time zone, IN "p_end_time" timestamp with time zone, IN "p_players" integer) TO "authenticated";
GRANT ALL ON PROCEDURE "public"."create_court_booking"(IN "p_user_id" "uuid", IN "p_court_id" integer, IN "p_start_time" timestamp with time zone, IN "p_end_time" timestamp with time zone, IN "p_players" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."create_court_booking"("p_user_id" "uuid", "p_court_id" "uuid", "p_start_time" "text", "p_end_time" "text", "p_players" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."create_court_booking"("p_user_id" "uuid", "p_court_id" "uuid", "p_start_time" "text", "p_end_time" "text", "p_players" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_court_booking"("p_user_id" "uuid", "p_court_id" "uuid", "p_start_time" "text", "p_end_time" "text", "p_players" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."create_notification"("p_user_id" "uuid", "p_type" "public"."notification_type", "p_title" "text", "p_message" "text", "p_data" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."create_notification"("p_user_id" "uuid", "p_type" "public"."notification_type", "p_title" "text", "p_message" "text", "p_data" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_notification"("p_user_id" "uuid", "p_type" "public"."notification_type", "p_title" "text", "p_message" "text", "p_data" "jsonb") TO "service_role";



GRANT ALL ON FUNCTION "public"."create_test_notifications"("p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."create_test_notifications"("p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_test_notifications"("p_user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."create_training_session"("p_student_id" "uuid", "p_coach_id" "uuid", "p_start_time" "text", "p_end_time" "text", "p_notes" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."create_training_session"("p_student_id" "uuid", "p_coach_id" "uuid", "p_start_time" "text", "p_end_time" "text", "p_notes" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_training_session"("p_student_id" "uuid", "p_coach_id" "uuid", "p_start_time" "text", "p_end_time" "text", "p_notes" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_xp_multiplier_details"("activity" "public"."activity_type") TO "anon";
GRANT ALL ON FUNCTION "public"."get_xp_multiplier_details"("activity" "public"."activity_type") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_xp_multiplier_details"("activity" "public"."activity_type") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."handle_match_completion"() TO "anon";
GRANT ALL ON FUNCTION "public"."handle_match_completion"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."handle_match_completion"() TO "service_role";



GRANT ALL ON FUNCTION "public"."handle_partner_request_response"() TO "anon";
GRANT ALL ON FUNCTION "public"."handle_partner_request_response"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."handle_partner_request_response"() TO "service_role";



GRANT ALL ON FUNCTION "public"."handle_winner_selection"() TO "anon";
GRANT ALL ON FUNCTION "public"."handle_winner_selection"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."handle_winner_selection"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."skill_level_to_int"("s" "public"."skill_level") TO "anon";
GRANT ALL ON FUNCTION "public"."skill_level_to_int"("s" "public"."skill_level") TO "authenticated";
GRANT ALL ON FUNCTION "public"."skill_level_to_int"("s" "public"."skill_level") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_player_level"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_player_level"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_player_level"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_player_stats_on_match_change"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_player_stats_on_match_change"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_player_stats_on_match_change"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_player_stats_on_xp_change"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_player_stats_on_xp_change"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_player_stats_on_xp_change"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."validate_match_selection"() TO "anon";
GRANT ALL ON FUNCTION "public"."validate_match_selection"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."validate_match_selection"() TO "service_role";
...
GRANT ALL ON TABLE "public"."login_streaks" TO "anon";
GRANT ALL ON TABLE "public"."login_streaks" TO "authenticated";
GRANT ALL ON TABLE "public"."login_streaks" TO "service_role";



GRANT ALL ON TABLE "public"."match_request_responses" TO "anon";
GRANT ALL ON TABLE "public"."match_request_responses" TO "authenticated";
GRANT ALL ON TABLE "public"."match_request_responses" TO "service_role";
...
GRANT ALL ON TABLE "public"."match_statistics" TO "anon";
GRANT ALL ON TABLE "public"."match_statistics" TO "authenticated";
GRANT ALL ON TABLE "public"."match_statistics" TO "service_role";



GRANT ALL ON TABLE "public"."match_winner_selections" TO "anon";
GRANT ALL ON TABLE "public"."match_winner_selections" TO "authenticated";
GRANT ALL ON TABLE "public"."match_winner_selections" TO "service_role";
...
GRANT ALL ON TABLE "public"."player_experience" TO "anon";
GRANT ALL ON TABLE "public"."player_experience" TO "authenticated";
GRANT ALL ON TABLE "public"."player_experience" TO "service_role";
...
GRANT ALL ON TABLE "public"."player_xp" TO "anon";
GRANT ALL ON TABLE "public"."player_xp" TO "authenticated";
GRANT ALL ON TABLE "public"."player_xp" TO "service_role";
...
GRANT ALL ON TABLE "public"."xp_multipliers" TO "anon";
GRANT ALL ON TABLE "public"."xp_multipliers" TO "authenticated";
